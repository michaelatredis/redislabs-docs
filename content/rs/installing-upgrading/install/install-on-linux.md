...
1. Copy the installation package to the node.
    ...
    _(Optional)_ Use the {{< download "GPG key file" "/rs/installing-upgrading/GPG-KEY-redislabs-packages.gpg" >}} to confirm authenticity of Ubuntu/Debian or RHEL RPM packages:
